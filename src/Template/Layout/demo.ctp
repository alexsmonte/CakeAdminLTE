...
<head>
    ...
    <!-- Theme style -->
    <?= $this->Html->css('AdminLTE.min.css',['fullBase' => true]) ?>
    <!-- AdminLTE Skins -->
    <?= $this->Html->css('skins/skin-blue.min.css',['fullBase' => true]) ?>
    <?= $this->Html->css('plugins/iCheck/flat/blue.css',['fullBase' => true]) ?>
    <?= $this->Html->css('plugins/morris/morris.css',['fullBase' => true]) ?>
    <?= $this->Html->css('plugins/jvectormap/jquery-jvectormap-1.2.2.css',['fullBase' => true]) ?>
    <?= $this->Html->css('plugins/datepicker/datepicker3.css',['fullBase' => true]) ?>
    <?= $this->Html->css('plugins/daterangepicker/daterangepicker.css',['fullBase' => true]) ?>
    <?= $this->Html->css('plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css',['fullBase' => true]) ?>
